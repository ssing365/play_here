            ...
            <Container>
                ...
                <Row className="mt-3">
                    ...
                    <div className="d-flex justify-content-between align-items-center">
                        <Button variant="outline-secondary" onClick={() => setMonth(month - 1)}>◀ 이전 달</Button>
                        <h5>{month}월</h5>
                        <Button variant="outline-secondary" onClick={() => setMonth(month + 1)}>다음 달 ▶</Button>
                    </div>
                    <table className="table table-bordered text-center mt-2">
                        ...
                        {calendarData.map((week, i) => (
                            <tr key={i}>
                            {week.map((day, j) => (
                                <td key={j} className="p-3" style={{ cursor: day ? "pointer" : "default" }}
                    ...
                    <div className="text-center mt-3">
                        <Link to="/map">
                        <Button variant="outline-success">지도 보기</Button>
                        </Link>
                    </div>
                    </Col>
                    ...
                    {selectedDate && (
                        <>
                        <h4>{month}월 {selectedDate}일 화</h4>
                        <h5>방문지 리스트</h5>
                        ...
                        {showInput ? (
                            ...
                            <Form.Control
                                ...
                                placeholder="장소 입력"
                            />
                            <Button className="mt-1" onClick={addPlace}>추가</Button>
                            </div>
                        ) : (
                            <a href="#" onClick={() => setShowInput(true)}>+ 추가하기</a>
                        )}
